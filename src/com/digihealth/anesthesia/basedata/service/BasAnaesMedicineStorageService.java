...
public class BasAnaesMedicineStorageService extends BaseService
{
	...
	public List<BasChargeAmountDetailRecordFormBean> queryChargeAmountDetailByMedId(SystemSearchFormBean systemSearchFormBean)
	{
		if(StringUtils.isEmpty(systemSearchFormBean.getBeid())){
			systemSearchFormBean.setBeid(getBeid());
		}
		...
		return basAnaesMedicineStorageDao.queryChargeAmountDetailByMedId(filters,systemSearchFormBean);
	}
	
	//根据时间统计记账药品总数
	public List<BasAnaesMedicineOutRecordFormBean> cntMedicineUseByOperat(SystemSearchFormBean systemSearchFormBean)
	{
		if(StringUtils.isEmpty(systemSearchFormBean.getBeid())){
			systemSearchFormBean.setBeid(getBeid());
		}
		...
		return basAnaesMedicineStorageDao.cntMedicineUseByOperat(filters, systemSearchFormBean);
	}
	//根据时间统计记账药品总数
	public int cntMedicineUseByOperatTotal(SystemSearchFormBean systemSearchFormBean)
	{
		if(StringUtils.isEmpty(systemSearchFormBean.getBeid())){
			systemSearchFormBean.setBeid(getBeid());
		}
		...
		return basAnaesMedicineStorageDao.cntMedicineUseByOperatTotal(filters,systemSearchFormBean);
	}
