...
public interface BasAnaesMedicineStorageDao {
    ...
    List<BasChargeAmountDetailRecordFormBean> queryChargeAmountDetailByMedId(@Param("filters")List<Filter> filters,@Param("systemSearchFormBean")SystemSearchFormBean systemSearchFormBean);
    
    List<BasAnaesMedicineOutRecordFormBean> cntMedicineUseByOperat(@Param("filters")List<Filter> filters,@Param("systemSearchFormBean")SystemSearchFormBean systemSearchFormBean);
    
    int cntMedicineUseByOperatTotal(@Param("filters")List<Filter> filters,@Param("systemSearchFormBean")SystemSearchFormBean systemSearchFormBean);
}