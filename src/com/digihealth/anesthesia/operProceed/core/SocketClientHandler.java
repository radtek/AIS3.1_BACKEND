...
public class SocketClientHandler extends SimpleChannelInboundHandler<Object> {
    ...
    protected void channelRead0(ChannelHandlerContext ctx, Object msg)
        ...
        logger.info("channelRead0------处理采集服务监测数据IP:" +ctx.channel().remoteAddress()+"---MSG:"+ msg);
        ...
        if (MyConstants.DATA_COLLECTOR_HEARTBEAT == msgType) {
        	...
        	MessageProcess.contextHandle(ctx,msgTxt);
        }
        logger.info("channelRead0----end--"+ctx.channel().remoteAddress()); 
    }
