...
/**
 * 
     * Title: BasPacuRecMonitorConfigDao.java    
     * Description: 监测点标记设置DAO接口
     * @author liukui       
     * @created 2015-10-7 下午5:54:49
 */
@MyBatisDao
public interface BasPacuRecMonitorConfigDao extends CrudDao<BasPacuRecMonitorConfig> {
	
	public List<BasAnaesMonitorConfigFormBean> getPacuRecRecordShowListByRegOptId(@Param("baseQuery") BaseInfoQuery baseQuery);
//	
...
//	
	public List<BasAnaesMonitorConfigFormBean> getPacuRecMonitorConfigListByRegOptId(@Param("baseQuery")BaseInfoQuery baseQuery);
//	
