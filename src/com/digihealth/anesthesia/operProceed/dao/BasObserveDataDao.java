...
public interface BasObserveDataDao {
     ...
     * 查询对应数据的点的数据
     */
    public List<BasObserveData> findObserveDataListByTimeYXRM(@Param("regOptId")String regOptId,@Param("time") String time, @Param("observeIds")List<String> observeIds);
