...
public class DocInstrubillItemService extends BaseService {
	...
	public DocInstrubillItem insertInstrubillItemByOptNurseIdAndRegOptId(String regOptId,String optNurseId,BasInstrument instrument,BasInstrSuitRel instrSuitRel, String type){
		...
		if(instrSuitRel == null){
			...
			instrubillItem.setHollowViscus(instrSuitRel.getAmount()); 
     ...
     */
    @Transactional
    public DocInstrubillItem insertInstrubillItemByOptNurseIdAndRegOptIdSYZXYY(String regOptId,String optNurseId,BasInstrument instrument,BasInstrSuitRel instrSuitRel, String type){
        DocOptNurse optNurse = docOptNurseDao.searchOptNurseById(optNurseId);
        BasUser user = UserUtils.getUserCache();
        DocInstrubillItem instrubillItem = new DocInstrubillItem();
        instrubillItem.setInstruItemId(GenerateSequenceUtil.generateSequenceNo());
        ...
        if(instrSuitRel == null){
            ...
            //instrubillItem.setOrigamount(instrSuitRel.getAmount());
            instrubillItem.setBasicNumber(instrSuitRel.getAmount());
            instrubillItem.setType(instrSuitRel.getType());
        }
