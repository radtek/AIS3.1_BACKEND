...
public class DocOptNurseRecordService extends BaseService {
	...
	private void setIOEvent(DocAnaesRecord anaesRecord, DocOptNurseRecord optNurseRec) {
		...
		Integer bleeding = evtEgressDao.getEgressCountValueByIoDefName("出血量", anaRecordId) == null ? 0 : evtEgressDao.getEgressCountValueByIoDefName("出血量", anaRecordId);
		optNurseRec.setBleeding(bleeding); // 失血量
		Integer urine = evtEgressDao.getEgressCountValueByIoDefName("尿量", anaRecordId) == null ? 0 : evtEgressDao.getEgressCountValueByIoDefName("尿量", anaRecordId);
		optNurseRec.setUrine(urine); // 尿量
		Integer hematocele = evtEgressDao.getEgressCountValueByIoDefName("积血量", anaRecordId) == null ? 0 : evtEgressDao.getEgressCountValueByIoDefName("积血量", anaRecordId);
		optNurseRec.setHematocele(hematocele); // 出量其他
		Integer outOther = evtEgressDao.getEgressCountValueByIoDefName("其他", anaRecordId) == null ? 0 : evtEgressDao.getEgressCountValueByIoDefName("其他", anaRecordId);
		optNurseRec.setOutOther(String.valueOf(outOther)); // 出量其他
		Integer outfusion = evtEgressDao.getEgressCountValueByIoDefName(null, anaRecordId) == null ? 0 : evtEgressDao.getEgressCountValueByIoDefName(null, anaRecordId);
